...
ENV_LOADER = Environment(
    loader=PackageLoader("edax", "eda/create_report/templates"),
)


def create_report(
    df: pd.DataFrame,
    title: Optional[str] = "EDAx Report",
    ...
    title: Optional[str], default "EDAx Report"
